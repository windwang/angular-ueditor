...
(function () {
    ...
    function createPreviewVideo(url) {
        ...
        $G("preview").innerHTML = '<div class="previewMsg"><span>' + lang.urlError + '</span></div><embed class="previewVideo" type="application/x-shockwave-flash" pl' +
                'uginspage="http://www.macromedia.com/go/getflashplayer" src="' + conUrl + '" width="' + 420 + '" height="' + 280 + '" wmode="transparent" play="true" loop="false" menu="false" allowscriptaccess="n' +
                'ever" allowfullscreen="true" ></embed>';
    }
